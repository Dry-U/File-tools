...
| 平台 | 下载 | 说明 |
|------|------|------|
| Windows | [NSIS 安装包](https://github.com/Dariandai/File-tools/releases) (.exe) | 推荐，自动创建桌面快捷方式 |
| Windows | [MSI 安装包](https://github.com/Dariandai/File-tools/releases) (.msi) | 企业部署 |
| Linux | [AppImage](https://github.com/Dariandai/File-tools/releases) / DEB | 开箱即用 |
| macOS | [DMG](https://github.com/Dariandai/File-tools/releases) | 拖拽安装 |
...
**本地模式**（Ollama、llama.cpp、LM Studio）：
```yaml
ai_model:
  mode: local
  local:
    api_url: http://localhost:11434/v1/chat/completions  # Ollama 默认端口 11434
    # llama.cpp 默认端口 8080
...
<p align="center">
  如有问题或建议，欢迎提交 <a href="https://github.com/Dariandai/File-tools/issues">Issue</a>
</p>
